...
<div class="min-h-screen bg-gradient-to-b from-blue-900 to-blue-700 flex justify-center items-center p-6">
  <div class="bg-white shadow-lg rounded-lg w-full max-w-lg p-8">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Edit Disease</h2>

    {{ Form::model($disease, ['route' => ['disease.update', $disease->disease_id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
    
    <div class="mb-4">
        <label for="disease_name" class="block text-gray-700 font-medium">Disease Name</label>
        {{ Form::text('disease_name', null, ['class' => 'w-full p-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200', 'id' => 'disease_name']) }}
